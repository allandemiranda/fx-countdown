...
@Table("indicator_rsi")
public record RSI(@Id @NotNull @Column("id") UUID id, @Column("dashboard_id") @NotNull UUID dashboardId, @NotNull @PastOrPresent @Column("timestamp") OffsetDateTime timestamp,
