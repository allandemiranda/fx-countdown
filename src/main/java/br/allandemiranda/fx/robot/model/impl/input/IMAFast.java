...
@Table("i_ma_fast")
public record IMAFast(@Id @Column("chart_id") @NotNull UUID id, @Column("expert_advisor_id") @NotNull UUID expertAdvisorId, @Column("ma_period") @Positive short period, @Column("ma_shift") @PositiveOrZero short shift,
