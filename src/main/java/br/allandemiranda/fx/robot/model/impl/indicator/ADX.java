...
@Table("indicator_adx")
public record ADX(@Id @NotNull @Column("id") UUID id, @Column("dashboard_id") @NotNull UUID dashboardId, @NotNull @PastOrPresent @Column("timestamp") OffsetDateTime timestamp, @NotNull @Column("main_line") BigDecimal mainLine,
