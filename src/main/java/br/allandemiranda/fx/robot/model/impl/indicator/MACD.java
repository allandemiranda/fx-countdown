...
public record MACD(@Id @NotNull @Column("id") UUID id, @Column("dashboard_id") @NotNull UUID dashboardId, @NotNull @PastOrPresent @Column("timestamp") OffsetDateTime timestamp, @Column("main_line") @NotNull BigDecimal mainLine,
