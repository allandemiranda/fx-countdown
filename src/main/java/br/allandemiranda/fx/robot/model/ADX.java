...
@Table(name = "ADX", indexes = {
    @Index(name = "idx_adx_symbol_period_timestamp_unq", columnList = "chart_id, timestamp", unique = true)
}, uniqueConstraints = {
    @UniqueConstraint(name = "uc_adx_symbol_period_timestamp", columnNames = {"chart_id", "timestamp"})
})
@Entity
public class ADX {
  ...
  public final boolean equals(Object o) {
    ...
    ADX adx = (ADX) o;
    return getId() != null && Objects.equals(getId(), adx.getId());
  }
