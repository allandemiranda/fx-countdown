...
public record IMASlowDto(@NotNull ChartDto chartDto, short period, short shift, @NotNull SmoothingMethod method, @NotNull AppliedPrice applyTo) implements Serializable, BaseDto, InputObjectDto {
