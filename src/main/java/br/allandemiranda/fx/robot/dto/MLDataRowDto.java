...
public record MLDataRowDto(@NotNull UUID chartId, @NotNull @PastOrPresent OffsetDateTime timestamp,
                           ...
                           // DATA ROW
                           @NotNull MLLabel label, @NotNull @NotEmpty List<@Valid ADX> adxList, @NotNull @NotEmpty List<@Valid ATR> atrList, @NotNull @NotEmpty List<@Valid Bands> bandsList, @NotNull @NotEmpty List<@Valid Candlestick> candlestickList,
                           @NotNull @NotEmpty List<@Valid GarchForecast> garchForecastList,
                           @NotNull @NotEmpty List<@Valid MACD> macdList, @NotNull @NotEmpty List<@Valid MaFast> maFastList, @NotNull @NotEmpty List<@Valid MaSlow> maSlowList, @NotNull @NotEmpty List<@Valid RSI> rsiList, @NotNull @NotEmpty List<@Valid Stochastic> stochasticList) implements
    Serializable {
