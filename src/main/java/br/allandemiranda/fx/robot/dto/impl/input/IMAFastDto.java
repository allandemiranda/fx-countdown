...
public record IMAFastDto(@NotNull UUID id, @Valid @NotNull ExpertAdvisorDto expertAdvisorDto, short period, short shift, @NotNull SmoothingMethod method, @NotNull AppliedPrice applyTo) implements Serializable,
    InputDto {
