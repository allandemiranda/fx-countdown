...
@UtilityClass
public final class RiskLevelCalculatorUtils {

  private static final MathContext MC = MathContext.DECIMAL64;

  public static LevelPrice fromSigmaAgg(BigDecimal price, BigDecimal pipSize, PositionType positionType, BigDecimal sigmaAgg, BigDecimal kSL, BigDecimal kTP) {
